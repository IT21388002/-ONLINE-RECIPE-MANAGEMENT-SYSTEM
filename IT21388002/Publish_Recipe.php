        ...
        <div class="main-content horizontal-content">
            ...
            <div class="container">
                ...
                <div class="breadcrumb-header justify-content-between">
                    <div class="my-auto">
                        <div class="d-flex">
                            <h4 class="content-title mb-0 my-auto">Publish Recipe</h4>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Publish Your Recipe</h4>

                                <form action="php/CreateRecipe.php" method="POST" enctype="multipart/form-data">
                                    <div class="">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea name="Make" class="form-control" rows="10"></textarea>
                                        </div>
                                    ...
                                    <button type="submit" class="btn btn-primary mt-3 mb-0">Publish</button>
                                </form>
                            </div>
                        </div>
                    </div>
