        ...
        <div class="main-content horizontal-content">
            ...
            <div class="container">
                ...
                <div class="breadcrumb-header justify-content-between">
                    <div class="my-auto">
                        <div class="d-flex">
                            <h4 class="content-title mb-0 my-auto">Trending Recipe</h4>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-8">
                        <div class="row">
                            ...
                            if (!isset($_GET['cat'])) {
                                ...
                                $cat = $_GET['cat'];
                                $sql = "SELECT * FROM recipes WHERE R_CATEGORY = $cat ";
                            }
                    ...
                    <div class="col-4">
                        <div class="card">
                            <div class="card-body">
                                <div class="card-title">Latest Recipes</div>
                                                ...
                                                ?>
                                                    ...
                                                    <a href="/iwt/IT21387012/Download.php?id=<?= $row['R_ID'] ?>">
                                                        <div class="row mb-2">
                                                            ...
                                                            <div class="col-7">
                                                                <div class="card-title"><?= $row['R_NAME'] ?></div>
