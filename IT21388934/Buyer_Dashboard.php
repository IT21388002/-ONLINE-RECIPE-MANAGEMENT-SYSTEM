        ...
        <div class="main-content horizontal-content">
            ...
            <div class="container">
                ...
                <div class="breadcrumb-header justify-content-between">
                    <div class="my-auto">
                        <div class="d-flex">
                            <h4 class="content-title mb-0 my-auto">Buyer Dashboard</h4>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-3">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <a href="/iwt/IT21386268/Become_a_publisher.php"><button class="btn btn-primary w-100 mb-2">Become a Publisher</button></a>
